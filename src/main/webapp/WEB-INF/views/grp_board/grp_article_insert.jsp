    ...
    <div class="page-wrap bg-gray p10">
        <div class="container p10 bg-white">
            ...
            <div class="board-insert">
                <form method="post" action="${pageContext.request.contextPath}/article/grp_article_insert" enctype="multipart/form-data">
                    ...
                    <div class="btn-grp center m-t10">
                        <button type="submit" class="btn-normal">게시글 작성</button>
